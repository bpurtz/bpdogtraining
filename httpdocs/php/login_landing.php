    ...
    <head>
        ...
        <script type="text/javascript">
            if (localStorage.getItem('user_id') == null) {
                localStorage.setItem('user_id', '<?php echo encrypt($_SESSION['user_id']); ?>');
            }
        </script>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div id="status-container">
                    <h3 class="text-center">Training Progress</h3>
                    <textarea class="form-control" id="status-input" placeholder="What training have you been up to?"></textarea>
                    <button class="btn btn-block btn-primary" id="status-submit">Submit</button>
                    <?php
                    //echo getUserStatus($_SESSION['user_id'], 0, 20);
                    ?>
                </div>
            </div>
