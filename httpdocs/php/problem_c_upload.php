...
function insertProblem() {
    ...
    //build query
    $query = "INSERT INTO cmd_problem(owner_id, post_date, tags, title, description, solutions_attempted, reaction, notes, pet_id)
              VALUES('$owner_id', now(), '$tags', '$title', '$description', '$solutions_attempted', '$reaction', '$notes', '$pet');";
    ...
    <form  id="upload_problem" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" maxlength="40" class="form-control col-10" id="title" name="title" required placeholder="Ex: Daisy's Down">
            </div>

            <div class="form-group col-md-6">
                <label class="form-label" for="tags">Tags</label>
                <input type="text" maxlength="40" class="form-control" id="tags" name="tags" required placeholder="Ex: command,sit,sitting,sitter">
            </div>
        </div>
        <div class="row">
...
POST;
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" required rows="10" name="description" id="description" placeholder="Describe the difficulty you are having training this command. The better the description, the better the answer." maxlength="1500"></textarea>
            </div>
        </div>
