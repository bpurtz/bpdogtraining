...
<body>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="#">Aggression</a>
                    </div>
                </li>
	...
	<section class="post container-fluid">
		<p>If you have seen any signs of aggression in your dog, I highly recommend you seek out a professional dog trainer immediately. An online environment is not sufficient to diagnose and prescribe a treatment plan for aggression. There are just too many factors involved and too much at risk. I do not condone the treatment of aggression by the owner. Sooner or later something will happen that is just not worth the risk.<br/><br/>
		I do offer my services to deal with aggressive dogs. I live in Southern Oregon and will fly internationally to come evaluate your dog in person. If you are interested in this service, please contact me and give me a brief description of the problem along with any incidences that have occurred.</p>
	</section>
